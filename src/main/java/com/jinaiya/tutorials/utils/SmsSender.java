...
public class SmsSender {
    ...
    // 短信模板ID，需要在短信应用中申请
    public static final int TEMPLATEID = 252379;

    // 签名
    public static final String SMSSIGN = "HackerNews";
    ...
    public static void main(String[] args) {
        smsSingleSender("17625655595", new String[]{"sbsbsb", "sxsxsx"});
        smsMultiSender(new String[]{"13013623154", "17605216762", "17551009216", "17625655595"}, new String[]{"你是小狗", "你是小🐶"});
    }
}
