package com.jinaiya.tutorials.telegram;
...
public class BuildVars {
    ...
    public static final String linkDB = "jdbc:mysql://localhost:3306/telegram_bot?useUnicode=true&characterEncoding=UTF-8";
